...
ap.add_argument("-f", "--folder", type=str,
                help="path to folder containng images")
...
def main():
    ...
    img_dir = args["folder"] # Directory of all images 
    ...
    for f1 in files:
        ...
        for (startX, startY, endX, endY) in boxes:
            ...
            # morphed image, preprocessing of image complete
            image = cv2.erode(imgContrast, kernel, iterations=1)
            ...
            # passing the image in model
            
            cmd="python main.py --i %s --beamsearch" %i
            os.system(cmd)
